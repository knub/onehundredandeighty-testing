...
\hline \hline
I    & \texttt{\emph{var} is already defined}           & 17          \\
II   & \texttt{Better use dot notation}                 & 11          \\
III  & \texttt{Missing semicolon}                       & 6          \\
IV   & \texttt{Unnecessary semicolon}                   & 3          \\
V    & \texttt{Use function form of "use strict"}       & 3          \\
VI   & \texttt{Don't define functions in loops}         & 1          \\
VII  & \texttt{Use !== to check for 0}                  & 1          \\
\hline
     &                                                  & \textbf{42 insgesamt} \\
\hline
\hline
...
\paragraph{\texttt{Fehler VII: Benutze !== um auf 0 zu prüfen.}}
