...
Das Tool \emph{TAJS}\footnote{http://www.brics.dk/TAJS/} ist ein Type Analyzer für Javascript, entwickelt von Anders Møller et al.
...
In Abbildung \ref{fig:tajs} ist beispielhaft der Flussgraph der in Kapitel \ref{sec:wirtschaft} vorgestellten Wirtschaftsregel\footnote{Code siehe \url{https://github.com/knub/onehundredandeighty/blob/testing/js/logic.js\#L674-L679}} zu sehen.
...
Beim Testen haben wir uns auf Graph Coverage an den beiden beispielhaften Fällen Control Flow Coverage und Use Cases konzentriert.
