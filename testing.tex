...
\begin{itemize}
    \item
        Spezifikation: Studienordnung des HPI -- \todo{Vorstellung Regeln, Vertiefungsgebiete}
    \item
...
Dabei haben wir versucht die Randfälle wie keine Elemente oder nur 1 Element eine Partition zu widmen, da diese oftmals die Fehler führen.
...
Wir haben uns 3 Tools angeschaut, welche statische Analyse für Javascript durchführen.

\paragraph{jshint}
Dieses Tool prüft die angegebenen javascript-Dateien auf mögliche Syntaxfehler. Wir haben von ihm die grunt integration benutzt, welches es ermöglicht die Analyse automatisch auszuführen und zusätzliche Parameter einfach einzustellen.
...
\paragraph{google code closure}
\emph{google code closure} ist kein klassisches Code Analyse Tool. Die eigentliche Funktion des Tools ist es, javascript code so zu compilieren, dass er schneller ausführbar ist. Dieses compilieren benutzt allerdings auch eine statische Analyses des Codes auf Korrektheit. Wir haben dieses Teil benutzt um unsere Anwendung überprüfen zu lassen.
