...
\todo{tajs: tool vorstellen
bild flowgraph wirtschatfsrule --> zuweisungen, abhängigkeiten, ... short circiut operation, car-decl, var-init, read....,
analysiert variable genutzt declaration --> nichts gefunden --> pessimistisch --> sicher das nicht drinnen ist
 }
